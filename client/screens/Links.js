...
const styles = StyleSheet.create({
    container: { flex: 1 },
    mainText: { fontSize: 30, textAlign: 'center', marginBottom: 20 },
    viewText: { fontSize: 20, color: '#ffc600', textAlign: 'center' },
    box: { backgroundColor: "#fff", width: 400, height: 300, borderRadius: 14, shadowColor: "#171717", shadowOffset: { width: -2, height: 4 }, shadowOpacity: 0.2,shadowRadius: 3, marginRight: 20},
